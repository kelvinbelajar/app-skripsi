    ...
    <div class="py-4 text-gray-500">
        ...
        <ul class="mt-6">
            ...
            @if (auth()->user()->hasrole('admin')||
                auth()->user()->hasrole('dinas'))
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('event-organizers.index') }}" :active="request()->routeIs('event-organizers.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                             stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @if (auth()->user()->hasrole('admin')||
                auth()->user()->hasrole('dinas')||
                auth()->user()->hasrole('event-organizer'))
            <li class="relative px-6 py-3">
            ...
            @if (auth()->user()->hasrole('admin')||
                ...
                auth()->user()->hasrole('event-organizer'))
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('acara_details.index') }}" :active="request()->routeIs('acara_details.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                             stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
            ...
            @if (auth()->user()->hasrole('admin')||
                auth()->user()->hasrole('dinas'))
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('pemasukans.index') }}" :active="request()->routeIs('pemasukans.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                             stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
            ...
            @if (auth()->user()->hasrole('admin')||
                auth()->user()->hasrole('dinas'))
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('pengeluarans.index') }}" :active="request()->routeIs('pengeluarans.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                             stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
            ...
            @if (auth()->user()->hasrole('admin')||
                ...
                auth()->user()->hasrole('event-organizer'))
            <li class="relative px-6 py-3">
                <x-nav-link href="{{ route('booking_tikets.index') }}" :active="request()->routeIs('booking_tikets.*')">
                    <x-slot name="icon">
                        <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                             stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
