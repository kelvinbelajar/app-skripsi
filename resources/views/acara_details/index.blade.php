                                ...
                                <td class="px-4 py-3 text-sm flex space-x-2">
                                    ...
                                    <a href="{{ route('acara_details.edit', $acaraDetail->id) }}"
                                        ...
                                        <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                                            ...
                                            viewBox="0 0 24 24">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="m14.304 4.844 2.852 2.852M7 7H4a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-4.5m2.409-9.91a2.017 2.017 0 0 1 2.847.1l2.645 3.28a2.017 2.017 0 0 1-.1 2.847l-6.54 6.54a2.017 2.017 0 0 1-2.846-.1l-2.645-3.28a2.017 2.017 0 0 1 .1-2.846l6.54-6.54Z" />
                                        </svg>
                                    </a>
