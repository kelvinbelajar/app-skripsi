...
<body>
    <section class="sheet">
        ...
        @foreach ($acaradetail as $acaraDetail)
            <table class="table">
                <tr>
                    <th class="text-center align-middle">Nama Organisasi</th>
                    <td class="text-center align-middle">{{ $acaraDetail->eventOrganizer->nama_organisasi }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Nama Acara</th>
                    <td class="text-center align-middle">{{ $acaraDetail->acara->nama_acara }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Kategori</th>
                    <td class="text-center align-middle">{{ $acaraDetail->acara->kategori }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Tanggal Mulai</th>
                    <td class="text-center align-middle">{{ $acaraDetail->jadwal->tanggal_mulai }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Tanggal Akhir</th>
                    <td class="text-center align-middle">{{ $acaraDetail->jadwal->tanggal_akhir }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Alamat</th>
                    <td class="text-center align-middle">{{ $acaraDetail->lokasi->address }}</td>
                </tr>
