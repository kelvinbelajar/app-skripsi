  ...
  <section class="sheet">
    ...
    <div class="header">
      ...
      <div class="left-align">
        <h2 style="margin: 0; font-size: 18px;"><b>Dinas Pendidikan Dan Kebudayaan Provinsi Kalimantan Selatan</b></h2>
    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th class="text-center align-middle">Email Organisasi</th>
          <th class="text-center align-middle">No. Rekening</th>
        </tr>
      </thead>
      <tbody>
        <?php $no = 1; ?>
        <?php foreach ($eventorganizer as $data) : ?>
        <tr>
          <td class="text-center align-middle"><?php echo $no; ?></td>
          <td class="text-center align-middle"><?php echo $data->nama_organisasi; ?></td>
          <td class="text-center align-middle"><?php echo $data->kontak; ?></td>
          <td class="text-center align-middle"><?php echo $data->email_organisasi ; ?></td>
          <td class="text-center align-middle"><?php echo $data->no_rekening ; ?></td>
        </tr>
        <?php $no++;
        endforeach; ?>
      </tbody>
