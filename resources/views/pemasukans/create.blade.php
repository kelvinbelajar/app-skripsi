<x-app-layout>
    ...
    <div class="p-4 bg-white rounded-lg shadow-xs">
        ...
        <form action="{{ route('pemasukans.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="date" id="tanggal_pemasukan" name="tanggal_pemasukan" value="{{ old('tanggal_pemasukan') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="nominal_pemasukan" name="nominal_pemasukan" value="{{ old('nominal_pemasukan') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">
