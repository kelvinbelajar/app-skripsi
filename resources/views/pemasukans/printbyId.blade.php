        ...
        @foreach ($pemasukan as $item)
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">{{ $item->tanggal_pemasukan }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Nominal Pemasukan</th>
                    <td class="text-center align-middle">{{ $item->nominal_pemasukan }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Bukti Pemasukan</th>
                    <td class="text-center align-middle">
                        @if ($item->bukti_pemasukan)
                            <a href="{{ asset('storage/bukti_pemasukan/' . $item->bukti_pemasukan) }}" target="_blank" class="text-blue-600 hover:underline">View File</a>
                        @else
                            N/A
                        @endif
                    </td>
