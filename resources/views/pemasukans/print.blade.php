        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="text-center align-middle">Tanggal Pemasukan</th>
                    <th class="text-center align-middle">Nominal Pemasukan</th>
                    <th class="text-center align-middle">Bukti Pemasukan</th>
                </tr>
            </thead>
            <tbody>
                <?php $no = 1; ?>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle"><?php echo $data->tanggal_pemasukan; ?></td>
                    <td class="text-center align-middle"><?php echo $data->nominal_pemasukan; ?></td>
                    <td class="text-center align-middle">
                        <?php if ($data->bukti_pemasukan): ?>
                        <a href="<?php echo asset('storage/bukti_pemasukan/' . $data->bukti_pemasukan); ?>" target="_blank" class="text-blue-600 hover:underline">View
                            File</a>
                        <?php else: ?>
                        N/A
                        <?php endif; ?>
