...
<body>
    <section class="sheet">
        ...
        <table class="table">
            ...
            <tbody>
                <?php $no = 1; ?>
                <?php foreach ($bookingtiket as $data) : ?>
                <tr>
                    ...
                    <td class="text-center align-middle"><?php echo $data->notelp; ?></td>
                    <td class="text-center align-middle"><?php echo $data->email; ?></td>
                    <td class="text-center align-middle">
                        <?php if ($data->bukti_bayar): ?>
                        <a href="<?php echo asset('storage/bukti_bayar/' . $data->bukti_bayar); ?>" target="_blank" class="text-blue-600 hover:underline">View
                            File</a>
                        <?php else: ?>
                        N/A
                        <?php endif; ?>
