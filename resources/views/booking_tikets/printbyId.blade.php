...
<body>
    <section class="sheet">
        ...
        @foreach ($bookingtiket as $ticket)
            <table class="table">
                <tr>
                    <th class="text-center align-middle">Nama Acara</th>
                    <td class="text-center align-middle">{{ $ticket->acara->nama_acara }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Nama Lengkap</th>
                    <td class="text-center align-middle">{{ $ticket->nama_lengkap }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">No. Telepon</th>
                    <td class="text-center align-middle">{{ $ticket->notelp }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Email</th>
                    <td class="text-center align-middle">{{ $ticket->email }}</td>
                </tr>
                <tr>
