        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle"><?php echo $data->tanggal_akhir; ?></td>
                    <td class="text-center align-middle"><?php echo $data->waktu_mulai; ?></td>
                    <td class="text-center align-middle"><?php echo $data->waktu_akhir; ?></td>
                </tr>
                <?php $no++;
        endforeach; ?>
            </tbody>
