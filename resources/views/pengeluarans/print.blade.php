        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="text-center align-middle">Tanggal Pengeluaran</th>
                    <th class="text-center align-middle">Nominal Pengeluaran</th>
                    <th class="text-center align-middle">Bukti Pengeluaran</th>
                </tr>
            </thead>
            <tbody>
                <?php $no = 1; ?>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle"><?php echo $data->tanggal_pengeluaran; ?></td>
                    <td class="text-center align-middle"><?php echo $data->nominal_pengeluaran; ?></td>
                    <td class="text-center align-middle">
                        <?php if ($data->bukti_pengeluaran): ?>
                        <a href="<?php echo asset('storage/bukti_pengeluaran/' . $data->bukti_pengeluaran); ?>" target="_blank" class="text-blue-600 hover:underline">View
                            File</a>
                        <?php else: ?>
                        N/A
                        <?php endif; ?>
