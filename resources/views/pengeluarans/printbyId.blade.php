        ...
        @foreach ($pengeluaran as $item)
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">{{ $item->tanggal_pengeluaran }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">
                        @if ($item->bukti_pengeluaran)
                            <a href="{{ asset('storage/bukti_pengeluaran/' . $item->bukti_pengeluaran) }}" target="_blank" class="text-blue-600 hover:underline">View File</a>
                        @else
                            N/A
                        @endif
                    </td>
