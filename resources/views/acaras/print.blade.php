        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="text-center align-middle">Estimasi Pengunjung</th>
                    <th class="text-center align-middle">Biaya Tiket</th>
                    <th class="text-center align-middle">EO</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center align-middle"><?php echo $data->nama_acara; ?></td>
                    <td class="text-center align-middle"><?php echo $data->kategori; ?></td>
                    <td class="text-center align-middle"><?php echo $data->deskripsi; ?></td>
                    <td class="text-center align-middle">
                        <img src="{{ public_path('storage/acaras/' . $data->gambar) }}" alt="gambar" width="50px"
                            height="50px">
                    </td>
                    <td class="text-center align-middle"><?php echo $data->estimasi_pengunjung; ?></td>
                    <td class="text-center align-middle"><?php echo $data->biaya_tiket; ?></td>
                    <td class="text-center align-middle"><?php echo $data->event_organizer->nama_organisasi; ?></td>
                    <td class="text-center align-middle"><?php echo $data->anggaran; ?></td>
                </tr>
                <?php $no++;
        endforeach; ?>
            </tbody>
