        ...
        @foreach ($acara as $data)
            <table class="table">
                ...
                <tr>
                    ...
                    <td class="text-center align-middle">{{ $data->deskripsi }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Gambar</th>
                    <td class="text-center align-middle">
                        <img src="{{ asset('storage/acaras/' . $data->gambar) }}" alt="Gambar" class="h-16 w-16 object-cover">
                    </td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Estimasi Pengunjung</th>
                    <td class="text-center align-middle">{{ $data->estimasi_pengunjung }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Biaya Tiket</th>
                    <td class="text-center align-middle">{{ $data->biaya_tiket }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">EO</th>
                    <td class="text-center align-middle">{{ $data->event_organizer->nama_organisasi }}</td>
                </tr>
                <tr>
                    <th class="text-center align-middle">Anggaran</th>
                    <td class="text-center align-middle">{{ $data->anggaran }}</td>
                </tr>
